...
if (isset($_POST['update'])) {
    ...
    header("Location: dashboard.php?page=list customer");
}

/* AMBIL DATA */
$data = mysqli_fetch_assoc(
    mysqli_query($conn, "SELECT * FROM pelanggan WHERE id_pelanggan='$id_pelanggan'")
);
?>
...
<div class="card">
    ...
    <form method="post">
        ...
        <div class="form-group">
            <label>email</label>
            <input type="number" name="email" value="<?= $data['email']; ?>" required>
        </div>


        <button type="submit" name="update" class="btn-edit">Update</button>
        <a href="dashboard.php?page=list customer" class="btn-hapus">Batal</a>
    </form>
</div>
